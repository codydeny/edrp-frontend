...
export default function Footer() {
  return (
    <div
      className="Footer print-friendly page-footer"
    ...
    >
      ...
      <div className="FooterLinkDiv">
        <div className="footerLink">
          ...
          <ListItem>
            <ListItemText
              style={{ color: "white" }}
              primary={"Learning Management System HNBGU"}
            />
          </ListItem>
        ...
        <div className="footerLink">
          <ListItem>
            <ListItemText
              style={{ color: "white" }}
              primary={"Training & Placement Cell"}
            />
          </ListItem>
      ...
      <div className="footerAddress">
        ...
        <div className="bottomFooterText">
          Developed & Maintained By IQAC Cell, HNB Garhwal University
        </div>
      </div>
      <div className="bottomFooter">
        Copyright © 2020 - All Rights Reserved - HNB Garhwal University{" "}
      </div>
    </div>
  );
}
