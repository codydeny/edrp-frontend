export const CRITERION_CONFIG = {
  1: {
    11: {
      description:
        "Programme for which syllabus revision was carried out during the acedemic year",
      step: 1,
      fields: [
        {
          name: "programme",
    ...
    12: {
      step: 2,
      description:
        "Programmes/Course focused on Employability/ enterpreneurship / skill development during acedemic year",
      fields: [
        {
          name: "programme",
          label: "Programme",
    ...
    42: {
      step: 6,
      description:
        "How Feedback Obtained is being analyzed and utilized for overall development of the department",
      fields: [
        {
          name: "feedback",
          label: "Feedback",
  ...
  2: {
    ...
    21: {
      ...
      fields: [
        ...
        },
        {
          ...
          label:
            "Full Time Teachers available in the department [only UG courses]",
          type: "number",
        },
        {
          name: "teachers_full_time_pg",
          label:
            "Full Time Teachers available in the department [only PG courses]",
          type: "number",
        },
        {
    ...
    32: {
      step: 4,
      description:
        "Students mentoring system available in the department? Give details. (maximum 500 words) ",
      fields: [
        {
  ...
  3: {
    11: {
      step: 1,
      description:
        "Teachers awarded National/International fellowship for advanced studies/ research during the year",
      fields: [
        {
          name: "type",
          label: "Type Of Award",
    ...
    13: {
      ...
      fields: [
        ...
        },
        {
          ...
          label:
            "no of students benefited by guidance for carrer counselling activities",
          type: "text",
        },
        {
    ...
    31: {
      ...
      fields: [
        ...
        },
        {
          ...
          label:
            "name of professional body for which membership fee is provided",
          type: "text",
        },
        {
          name: "amount",
    ...
    32: {
      ...
      fields: [
        ...
        },
        {
          name: "title_of_programme",
          label:
            "title of professional development programme organized for teaching staff",
          type: "text",
        },
        {
          name: "title_of_admin_training_programme",
          label:
            "title of administrative training programme organised for non-teching staff",
          type: "text",
        },
        {
          name: "date_to",
      ...
      fields: [
        {
          ...
          label:
            "2 Environmental Consciousness and Sustainability/Alternate Energy initiatives",
          type: "text",
          extras: {
            multiline: true,
            rows: 4,
    ...
    14: {
      ...
      fields: [
        ...
        },
        {
          ...
          label:
            "no of initiatives to address  locational advantage and disadvantage",
          type: "number",
        },
        {
          name: "no_of_initiatives_taken",
          label:
            "no of initiatives taken to engage with and contribute to local community",
          type: "number",
        },
        {
      ...
      fields: [
        {
          ...
          label:
            "Initiatives taken by the department to make the campus eco-friendly ",
          type: "text",
          extras: {
            multiline: true,
            rows: 4,
