...
export const TeacherForm = (props) => {
  ...
  const submitForm = (e) => {
    ...
    store.submitFacultyForm(
      e.target,
      store.state.facultyResume.id,
      props.closeFunc
    );
  };
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                variant="outlined"
                name="name"
                defaultValue={store.state.facultyResume.name}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                variant="outlined"
                name="duty"
                defaultValue={store.state.facultyResume.duty}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                variant="outlined"
                name="orcid_id"
                defaultValue={store.state.facultyResume.orcid_id}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                variant="outlined"
                name="mobile"
                defaultValue={store.state.facultyResume.mobile}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                defaultValue={store.state.facultyResume.email_secondary}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                variant="outlined"
                name="designation"
                defaultValue={store.state.facultyResume.designation}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                defaultValue={
                  store.state.facultyResume.educational_qualification
                }
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                defaultValue={store.state.facultyResume.research_experience}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                defaultValue={store.state.facultyResume.teaching_experience}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <Button
